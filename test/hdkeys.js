...
var HDPrivateKey = aidpcore.HDPrivateKey;
var HDPublicKey = aidpcore.HDPublicKey;
...
describe('BIP32 compliance', function() {
  ...
  describe('edge cases', function() {
    ...
    it('will handle edge case that derived private key is invalid', function() {
      ...
      var unstubbed = aidpcore.crypto.BN.prototype.toBuffer;
      var count = 0;
      var stub = sandbox.stub(aidpcore.crypto.BN.prototype, 'toBuffer', function(args) {
      ...
      sandbox.spy(aidpcore.PrivateKey, 'isValid');
      var key = HDPrivateKey.fromObject({
        network: 'testnet',
        depth: 0,
        parentFingerPrint: 0,
      ...
      aidpcore.PrivateKey.isValid.callCount.should.equal(2);
    });
    it('will handle edge case that a derive public key is invalid', function() {
      ...
      var unstubbed = aidpcore.PublicKey.fromPoint;
      aidpcore.PublicKey.fromPoint = function() {
        aidpcore.PublicKey.fromPoint = unstubbed;
