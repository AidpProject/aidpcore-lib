...
var script_tests = require('../data/aidpd/script_tests');
var tx_valid = require('../data/aidpd/tx_valid');
var tx_invalid = require('../data/aidpd/tx_invalid');

//the script string format used in aidpd data tests
Script.fromAidpdString = function(str) {
...
describe('Interpreter', function() {
  ...
  var testFixture = function(vector, expected, witness, amount) {
    amount = amount || 0;
    var scriptSig = Script.fromAidpdString(vector[0]);
    var scriptPubkey = Script.fromAidpdString(vector[1]);
  ...
  describe('aidpd script evaluation fixtures', function() {
  ...
  describe('aidpd transaction evaluation fixtures', function() {
      ...
      set.forEach(function(vector) {
        ...
        it('should pass tx_' + (expected ? '' : 'in') + 'valid vector ' + cc, function() {
          ...
          inputs.forEach(function(input) {
            ...
            if (txoutnum === -1) {
              txoutnum = 0xffffffff; //aidpd casts -1 to an unsigned int
            }
            map[txid + ':' + txoutnum] = Script.fromAidpdString(scriptPubKeyStr);
          });
