...
var JSUtil = aidpcore.util.js;
var Interpreter = aidpcore.Script.Interpreter;

var sig_canonical = require('../data/aidpd/sig_canonical');
var sig_noncanonical = require('../data/aidpd/sig_noncanonical');
...
describe('Signature', function() {
  ...
  describe('@isTxDER', function() {
    ...
    describe('aidpd fixtures', function() {
