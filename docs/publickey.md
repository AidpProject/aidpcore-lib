# Public Key
Represents a aidpcoin public key and is needed to be able to receive aidpcoin, as is usually represented as a aidpcoin [Address](address.md). See the official [Bitcoin Wiki](https://en.bitcoin.it/wiki/Technical_background_of_version_1_Bitcoin_addresses).

A PublicKey in Aidpcore is an immutable object and can be instantiated from a [Point](crypto.md), string, [PrivateKey](privatekey.md), Buffer or a [BN](crypto.md).
...
> var compressedPK2 = new aidpcore.PublicKey('02a1633cafcc01ebfb6d78e39f687a1f'+
...
> var uncompressed = aidpcore.PublicKey('0479BE667EF9DCBBAC55A06295CE870B07029'+
